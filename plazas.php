...
require_once 'src/classes/plazas.class.php';
...
switch ($_SERVER['REQUEST_METHOD']) {
	 ...
	 */
	case 'DELETE':
		if(!isset($_GET['id_plaza']) || empty($_GET['id_plaza'])){
			$response = array(
				'result' => 'error',
				'details' => 'Error en la solicitud'
			);
