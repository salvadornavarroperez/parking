<?php
/**
 * Clase para el modelo que representa a la tabla "socios".
 */
require_once 'src/response.php';
require_once 'src/database.php';

class Socios extends Database
{
	/**
	...
	public function update($id, $params)
	{
		...
		if ($this->validate($params)) {
			$affected_rows = parent::updateDB($this->table, $id, $params,"Id_socio");
	...
	{
		$affected_rows = parent::deleteDB($this->table, $id,"Id_socio");
